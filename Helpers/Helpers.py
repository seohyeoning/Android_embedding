...
from Helpers.Variables import device, WD, DATA_DIR, CLASS_NUM, Make_COL_NAMES
...
def import_data(path):
    ...
    features.columns = Make_COL_NAMES(False)
    
    return features, labels   

 ########## Window segmentation 
def segment(data, label, window_size=625, step_=625): # no overlapping
    feature_list = []
    label_list = []
